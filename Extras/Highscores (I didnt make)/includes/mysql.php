<?php
// MYSQL
mysql_connect('localhost', 'ian_high', '3l?mJ%WT$5XD');
mysql_select_db('ian_highscores');
...
$top_hiscore = 1000001;
$minlvltohiscore = 10;
$website = "http://www.anarchypk.com/highscores";
$webtwo = "http://www.anarchypk.com/";
$images = "http://www.anarchypk.com/images/";
$file = "index.php";
$file2 = "skills.php";
$pers = "personal.php";
...
// BBCODE
$webbers_code	= '<img src="http://www.anarchypk.com/highscores/images/moderator.gif" border="0" />';
$admins_code	= '<img src="http://www.anarchypk.com/highscores/images/admin.gif" border="0" />';
$mods_code	= '<img src="http://www.anarchypk.com/highscores/images/moderator.gif" border="0" />';
$high_mods_code	= '<img src="http://i34.tinypic.com/1zeccg9.jpg" border="0" />';
$donators_code	= '<img src="http://www.anarchypk.com/highscores/images/donator.gif" border="0" />';
