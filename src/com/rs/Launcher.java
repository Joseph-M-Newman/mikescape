...
public final class Launcher {
	...
	//public static MainLoader vote = new MainLoader("Webhost i[", "Username", "Pass", "Database Name");
	...
	public static void main(String[] args) throws Exception {
		...
		Logger.log("Launcher", "Snoop is " + Settings.SNOOP);
		Logger.log("Launcher", "Debug is " + Settings.DEBUG);
		
		try {
			ServerChannelHandler.init();
			NPCSpawning.spawnNPCS();
			NPCCombatDefinitionsL.loadCustomNPCDefinitions();
		} catch (Throwable e) {
			Logger.handle(e);
			Logger.log("Launcher",
