...
public class PartyDemo extends NPC {

	public PartyDemo(int id, WorldTile tile, int mapAreaNameHash,
			boolean canBeAttackFromOutOfArea) {
		super(id, tile, mapAreaNameHash, canBeAttackFromOutOfArea);
		// TODO Auto-generated constructor stub
	}

	public void PartyDemon(int id, WorldTile tile, int mapAreaNameHash,
