                ...
                if (!unlockedEmotes.contains(id)) {
                        ...
                        if (id == 0) {//Yes
                                ...
                                player.setNextAnimation(new Animation(12931));
                                       ...
                                       player.setNextAnimation(new Animation(10735));
									   
                                } else if (id == 71) {//Begging
                                       player.setNextAnimation(new Animation(17162));//kick ground disapointed
									   
                                } else if (id == 72) {//Stir Cauldron
										player.setNextAnimation(new Animation(17080));  //frog
											player.setNextGraphics(new Graphics(3220));
                                } else if (id == 73) {//Cheer
                                			 player.setNextAnimation(new Animation(17144));
										
                                } else if (id == 74) {//Tantrum
                                		player.setNextAnimation(new Animation(17101));  //backflip
										
                                } else if (id == 75) {//Dramatic Death
                                 		player.setNextAnimation(new Animation(17103));  //lucien transform
										player.setNextGraphics(new Graphics(3222));
                                } else if (id == 76) {//Jump & Yell
                                 		player.setNextAnimation(new Animation(17142));  //fall on face
										
                                } else if (id == 77) {//Point 
                                 		player.setNextAnimation(new Animation(17187));  //laugh
										
                                } else if (id == 78) {//Punch
                                    		player.setNextAnimation(new Animation(17077));  //grave dig
											player.setNextGraphics(new Graphics(3219));
										
                                } else if (id == 79) {//Raise Hand
                                   		player.setNextAnimation(new Animation(17175));
                                        ...
                                        WorldTasksManager.schedule(new WorldTask() {
                                                ...
                                                public void run() {
                                                        if (step == 0) {
                                                                player.setNextAnimation(new Animation(17179));
                                                        } else if (step == 2) {
                                                                player.setNextAnimation(new Animation(17180));
                                                        } else if (step == 4) {
                                                           player.setNextAnimation(new Animation(17181));
														   }
                                                        step++;
                                                }
                                   		...
                                   		player.setNextAnimation(new Animation(17196)); //kick 
										
                                } else if (id == 82) {//Raise Hand (Sitting)
                                  		player.setNextAnimation(new Animation(17166)); //dance 
										
                                } else if (id == 83) {//Wave (Sitting)
                                  		player.setNextAnimation(new Animation(17163));  //mexican wave
										
                                } else if (id == 84) {//Cheer (Sitting)
                                  		player.setNextAnimation(new Animation(17079));  //brekadance
										
                                } else if (id == 85) {//Throw Tomato (Sitting)
                                 		
                                 		player.setNextAnimation(new Animation(17193));   
										
                                } else if (id == 86) {//Throw Flowers (Sitting)
                                 		player.setNextAnimation(new Animation(16913));  //confetti
										player.setNextGraphics(new Graphics(3175));
										
                                } else if (id == 87) {//Agree (Sitting)
                                 		player.setNextAnimation(new Animation(17191)); //gnome copter  
									...
									public void run() {
										if (step == 0) {
											player.setNextForceTalk(new ForceTalk("#Manilow Swag"));
											player.setNextAnimation(new Animation(10452));
										} else if (step == 1) {
											player.setNextForceTalk(new ForceTalk("Im safe from the past, and doing ok, but not very well."));
													player.setNextAnimation(new Animation(791));
										} else if (step == 4) {
											player.setNextForceTalk(new ForceTalk("No jolts no Surprises, No crisis Arises!"));
											   player.setNextAnimation(new Animation(6396));
											   
										} else if (step == 7) {
											player.setNextForceTalk(new ForceTalk("My life goes along as it should. "));
											   player.setNextAnimation(new Animation(15524));
											   
										} else if (step == 10) {
											player.setNextForceTalk(new ForceTalk("Its all very nice, but not very good!......."));
											   player.setNextAnimation(new Animation(6398));
											   
										} else if (step == 13) {
											player.setNextForceTalk(new ForceTalk("And Im Ready To Take A Chance Again!"));
											   player.setNextAnimation(new Animation(9052));
											   
									   } else if (step == 16) {
											player.setNextForceTalk(new ForceTalk("Ready to put my love on the line, with you!"));
											   player.setNextAnimation(new Animation(9031));
											   
									   } else if (step == 19) {
											player.setNextForceTalk(new ForceTalk("Been living with nothing to show for it..."));
											   player.setNextAnimation(new Animation(9055));
											   
									   } else if (step == 22) {
										player.setNextForceTalk(new ForceTalk("You get what you get when you go for it......"));
									...
									public void run() {
										if (step == 0) {
											player.getPackets().sendGameMessage("Lets chat while we Dance");
											player.setNextAnimation(new Animation(7071));
											player.getPackets().sendPanelBoxMessage("This is the P0aniz3r Pr0j3ct Sauce.");
										} else if (step == 1) {
											player.getPackets().sendPanelBoxMessage("Developed by: P0 with help from An@rchyPK Edits by 1an, P33p@w + P1nu");
											
										} else if (step == 4) {
											player.getPackets().sendPanelBoxMessage("The L33t is being used so searches dont keyword find this.");
										} else if (step == 7) {
											player.getPackets().sendPanelBoxMessage("The Sauce is basically Ext1incti0n V3. ");
										} else if (step == 10) {
											player.getPackets().sendPanelBoxMessage("However 'D3v0urz' decided to claim Ext1ncti0n as his server.");
											  
										} else if (step == 13) {
											player.getPackets().sendPanelBoxMessage("He opened one with me + K1w1 called 'Ext1ncti0n V2'.");
											 
									   } else if (step == 16) {
											player.getPackets().sendPanelBoxMessage("He C0ded nothing really but claims he 'c0ded' the release.");
											 
									   } else if (step == 19) {
											player.getPackets().sendPanelBoxMessage("If you think your 0wner Lies as well and claims content");
											  
									   } else if (step == 22) {
										player.getPackets().sendPanelBoxMessage("Just google 'The P0aniz3r Pr0ject R3lease' and look at the content.");
											...
											step++;
                                       		...
                                       		player.setNextAnimation(new Animation(17212));//sunbath
											
                                } else if (id == 91) {//Thumbs-Down (Sitting)
                                     		player.setNextAnimation(new Animation(16380));//wolf
											player.setNextGraphics(new Graphics(3013));
											player.setNextGraphics(new Graphics(3016)); 
																	
                                } else if (id == 92) {//Clap (Sitting)
                                     		
								player.setNextAnimation(new Animation(16376));//natures might
								player.setNextGraphics(new Graphics(3011));
								player.getPackets().sendGameMessage("Jagex watches to much Hentai....");
