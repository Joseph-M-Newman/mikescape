...
public class InterfaceManager {
	...
	public void sendMsPort() {
                sendTab(resizableScreen ? 93 : 207, 205);
                player.getPackets().sendIComponentText(205, 0,  "<col=ff00ff><Img=6>1");
                player.getPackets().sendIComponentText(205, 1, "<col=FCFF00><Img=6>2");
                player.getPackets().sendIComponentText(205, 2, "<col=FCFF00><Img=6>3");
                player.getPackets().sendIComponentText(205, 3, "<col=FCFF00><Img=6>4");
                player.getPackets().sendIComponentText(205, 4, "<col=FCFF00><Img=6>5");
                player.getPackets().sendIComponentText(205, 5, "<col=FCFF00><Img=6>6");
                player.getPackets().sendIComponentText(205, 6, "<col=FCFF00><Img=6>7");
                player.getPackets().sendIComponentText(205, 7, "<col=FCFF00><Img=6>8");
                player.getPackets().sendIComponentText(205, 8,  "<col=ff00ff><Img=6>9");
                player.getPackets().sendIComponentText(205, 9, "<col=FCFF00><Img=6>10");
                player.getPackets().sendIComponentText(205, 10, "<col=FCFF00><Img=6>11");
                player.getPackets().sendIComponentText(205, 11, "<col=FCFF00><Img=6>12");
                player.getPackets().sendIComponentText(205, 12, "<col=FCFF00><Img=6>13");
