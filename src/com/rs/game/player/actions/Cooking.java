...
public class Cooking extends Action {
	...
	public enum Cookables {
		...
		/**
		 * Cooked Meat
		 */            // item, amount, Level,?,XP (1600X),burnt outcome, amount,cookedoutcome, amount
		 ...
		 * Cooked Chicken
		 */
		RAW_CHICKEN(new Item(2138, 1), 1, 200, 1, new Item(2144, 1), new Item(
				2140, 1), false, false),

		/**
		 * Ugthanki Meat
		 */
		RAW_UGTHANKI_MEAT(new Item(1859, 1), 1, 200, 10, new Item(2146, 1),
				new Item(1861, 1), false, false),

		/**
		 * Raw Rabbit
		 */
		RAW_RABBIT(new Item(3226, 1), 1, 200, 10, new Item(7222, 1), new Item(
				3228, 1), false, true),
		 ...
		 * CrayFish
		 */
		RAW_CRAYFISH(new Item(13435, 1), 1, 32, 10, new Item(13437, 1),
				new Item(13433, 1), false, false),

		/**
		 * Shrimp
		 */
		RAW_SHRIMP(new Item(317, 1), 1, 34, 1, new Item(7954, 1), new Item(
				315, 1), false, false),
		 ...
		 * Sardine
		 */
		RAW_SARDINE(new Item(327, 1), 1, 38, 2, new Item(323, 1), new Item(
				325, 1), false, false),

		/**
		 * Anchovies
		 */
		RAW_ANCHOVIES(new Item(321, 1), 1, 34, 3, new Item(323, 1), new Item(
				319, 1), false, false),
		 ...
		 * Herring
		 */
		RAW_HERRING(new Item(345, 1), 5, 37, 4, new Item(357, 1), new Item(
				347, 1), false, false),

		/**
		 * Mackerel
		 */
		RAW_MACKEREL(new Item(353, 1), 10, 45, 5, new Item(357, 1), new Item(
				355, 1), false, false),

		/**
		 * Trout
		 */
		RAW_TROUT(new Item(335, 1), 15, 50, 6, new Item(343, 1), new Item(333,
				1), false, false),

		/**
		 * Cod
		 */
		RAW_COD(new Item(341, 1), 18, 39, 7, new Item(343, 1),
				new Item(339, 1), false, false),

		/**
		 * Pike
		 */
		RAW_PIKE(new Item(349, 1), 20, 52, 11, new Item(349, 1), new Item(351,
				1), false, false),

		/**
		 * Salmon
		 */
		RAW_SALMON(new Item(331, 1), 25, 58, 8, new Item(343, 1), new Item(
				329, 1), false, false),
		 ...
		 * Tuna
		 */
		RAW_TUNA(new Item(359, 1), 30, 63, 11, new Item(367, 1), new Item(361,
				1), false, false),
		 ...
		 * Lobster
		 */
		RAW_LOBSTER(new Item(377, 1), 40, 66, 14, new Item(381, 1), new Item(
				379, 1), false, false),

		/**
		 * Bass
		 */
		RAW_BASS(new Item(363, 1), 43, 80, 15, new Item(367, 1), new Item(365,
				1), false, false),

		/**
		 * SwordFish
		 */
		RAW_SWORDFISH(new Item(371, 1), 45, 86, 17, new Item(375, 1),
		 ...
		 * MonkFish
		 */
		RAW_MONKFISH(new Item(7944, 1), 62, 90, 23, new Item(7948, 1),
				new Item(7946, 1), false, false),

		/**
		 * Shark
		 */
		RAW_SHARK(new Item(383, 1), 80, 100, 40, new Item(387, 1), new Item(
				385, 1), false, false),

		/**
		 * Sea turtle
		 */
		RAW_SEA_TURTLE(new Item(395, 1), 82, 200, 43, new Item(399, 1),
				new Item(397, 1), false, false),

		/**
		 * Cavefish
		 */
		RAW_CAVEFISH(new Item(15264, 1), 88, 200, 42, new Item(15268, 1),
				new Item(15266, 1), false, false),

		/**
		 * Manta Ray
		 */
		RAW_MANTA_RAY(new Item(389, 1), 91, 200, 45, new Item(393, 1),
				new Item(391, 1), false, false),

		/**
		 * RockTail
		 */
		RAW_ROCKTAIL(new Item(15270, 1), 92, 200, 62, new Item(15274, 1),
		 ...
		 * Wild Pie
		 */
		RAW_WILD_PIE(new Item(7206, 1), 85, 200, 200, new Item(2329, 1),
