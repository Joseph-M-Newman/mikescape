...
public class Hunter extends Action {
	...
	public enum HunterNPC {
		...
		//NAME(npc,caught item,level,xp)
		CARNIVOROUS_CHINCHOMPA(5080, 10034, 63, 60, HunterEquipment.BOX, 28558), 
		FERRT(5081, 10092, 27, 7, HunterEquipment.BOX, 19189), 
		GECKO(6916,12184, 27, 10, HunterEquipment.BOX, 19190),
		RACCOON(7272,12487, 27, 7, HunterEquipment.BOX, 19191), 
		MONKEY(6942,12201, 27, 7, HunterEquipment.BOX, 28557), 
		
		CRIMSON_SWIFT(5073, 10088, 1, 4, HunterEquipment.BRID_SNARE, 19180),
		GOLDEN_WARBLER(5075, 1583, 5, 3, HunterEquipment.BRID_SNARE, 19184),
		COPPER_LONGTAIL(5076, 10091, 9, 4, HunterEquipment.BRID_SNARE, 19186), 
		CERULEAN_TWITCH(5074, 10089, 11, 5, HunterEquipment.BRID_SNARE, 19182), 
		TROPICAL_WAGTAIL(5072, 10087, 19, 12, HunterEquipment.BRID_SNARE, 19178), 
		WIMPY_BIRD(7031, 11525, 39, 7, HunterEquipment.BRID_SNARE, 28930);
	...
	public enum HunterEquipment {
		...
		BOX(10008, 19187, new Animation(5208), 27), BRID_SNARE(10006, 19175, new Animation(5207), 1);
