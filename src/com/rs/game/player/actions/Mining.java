...
public final class Mining extends Action {
	...
	public static enum RockDefinitions {
				//Name(level,xp, ore 
		Copper_Ore(1, 2, 436, 10, 1, 11552, 5, 0), Tin_Ore(1, 2, 438, 15,1, 11552, 5, 0), 
		Iron_Ore(15, 5, 440, 15, 1, 11552, 10, 0), Sandstone_Ore(35, 30, 6971, 30, 1, 11552, 10, 0), 
		Silver_Ore(20, 10, 442, 25,1, 11552, 20, 0), Coal_Ore(30, 20, 453, 50, 10, 11552, 30, 0), 
		Granite_Ore(45, 50, 6979, 50, 10, 11552, 20, 0), Gold_Ore(40, 50, 444, 80,20, 11554, 40, 0), 
		Mithril_Ore(55, 80, 447, 100, 20, 11552, 60,0), Adamant_Ore(70, 100, 449, 130, 25, 11552, 180, 0), 
		Runite_Ore(85, 200, 451, 150, 30, 11552, 70, 0);
		...
		if (weaponId != -1) {
			...
			case 13661: // Inferno adze
				if (level >= 61) {
					...
					if (!player.isDonator()) {
						player.getPackets().sendGameMessage( "Only Donators can use this.");
											}
					else{
						if (level >= 61) {
							emoteId = 10222;
