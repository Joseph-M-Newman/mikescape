...
public final class Woodcutting extends Action {
	...
	public static enum TreeDefinitions {
	  ...
	  //NAME(level,xp x3200,logs,?,?,stump id,respawn,?
		NORMAL(1, 1, 1511, 20, 4, 1341, 8, 0), // TODO
		
		DEAD(1, 1, 1511, 20, 4, 12733, 8, 0),

		OAK(15, 2, 1521, 30, 4, 1341, 15, 15), // TODO

		WILLOW(30, 4, 1519, 60, 4, 1341, 51, 15), // TODO

		MAPLE(45, 5.5, 1517, 83, 16, 31057, 72, 10),

		YEW(60, 8, 1515, 120, 17, 1341, 94, 10), // TODO

		IVY(68, 0, -1, 120, 17, 46319, 58, 10),

		MAGIC(75, 30, 1513, 150, 21, 37824, 121, 10),

		CURSED_MAGIC(82, 40, 1513, 150, 21, 37824, 94, 10),
		
		MUTATED_JADE(95, 35, 21358, 185, 15, -1, 199, 10);
		private int level;
		private double xp;
		private int logsId;
