	...
	public static final boolean checkCombatSpell(Player player, int spellId,
		...
		case 192:
			...
			case 47: // crumble undead
				if (!checkSpellRequirements(player, 99, delete, FIRE_RUNE, 100,
						AIR_RUNE, 100, CHAOS_RUNE, 100, EARTH_RUNE, 100, MIND_RUNE, 100,
						NATURE_RUNE, 100, DEATH_RUNE, 100, BLOOD_RUNE, 100, SOUL_RUNE, 100,
						ASTRAL_RUNE, 100, LAW_RUNE, 100, ARMADYL_RUNE, 100
						))
					return false;
				break;
			case 49: // air blast
		...
		case 430:
			switch (spellId) {
				case 52: // heal other
						if (!checkSpellRequirements(player, 92, delete, ASTRAL_RUNE, 3,
								LAW_RUNE, 3, BLOOD_RUNE, 3))
			return false;
				break;
			default:
				return false;
