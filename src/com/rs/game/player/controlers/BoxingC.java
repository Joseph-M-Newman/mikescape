...
public class BoxingC extends Controler {
...
player.setNextForceTalk(new ForceTalk("Mode"));
	...
	@Override
	public void process() {
		player.setNextForceTalk(new ForceTalk("Process"));
		if (bosses != null) {
			if (bossesDead()) {
				bosses = null;
	...
	public void sendInterfaces() {
		player.setNextForceTalk(new ForceTalk("inters"));
		if (bosses != null) {
	...
	player.setNextForceTalk(new ForceTalk("login"));
