...
public class HomeCutScene extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		actionsList.add(new NPCForceTalkAction(GUTHIX, "Extinction!", -1));
		...
		actionsList.add(new NPCForceTalkAction(GUARD1, "You must not know, your on Fundraise RS, its da best!",
				2));
