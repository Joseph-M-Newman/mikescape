...
public class JackCutScene extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		actionsList.add(new CreateNPCAction(GUTHIX, 8519, 10, 6, 0, -1));
		actionsList.add(new NPCFaceTileAction(GUTHIX, 10, 5, -1));
		actionsList.add(new NPCGraphicAction(GUTHIX, new Graphics(184), 2));

		actionsList.add(new NPCForceTalkAction(GUTHIX, "What do you want?", 3));

		actionsList.add(new NPCForceTalkAction(GUTHIX, "Leave me alone..!", -1));
		actionsList.add(new NPCAnimationAction(GUTHIX, new Animation(860), 3)); // headbang

		actionsList.add(new NPCFaceTileAction(GUTHIX, 9, 6, -1));

		actionsList.add(new MovePlayerAction(9, 5, false, 2));
