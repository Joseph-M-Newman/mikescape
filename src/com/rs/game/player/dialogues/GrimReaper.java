...
public class GrimReaper extends Dialogue {
	...
	public void start() {
		...
		sendEntityDialogue(SEND_3_TEXT_CHAT,
				new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
						"Hello, I am the Grim Reaper, Extinction-V2's newcomers guide.",
						"Extinction-V2 was created by Devourz,",
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			new String[] { player.getDisplayName(), "Oh Chur MR Reaper Man Sir, I hope this is worth my time." },
			IS_PLAYER, player.getIndex(), 12379);
			stage = 1;
		} else if (stage == 1) {
			sendEntityDialogue(SEND_4_TEXT_CHAT,
					new String[] { NPCDefinitions.getNPCDefinitions(npcId).name, "Oh please, EXTINCTION-V2 is the Best.",
								"You can view our range of teleports and commands,",
								"by clicking the quest tab and clicking any button.",
								"Only donate to Rhys/Devourz"}, IS_NPC, npcId, 12379);
			stage = 2;
		} else if (stage == 2) {
			sendEntityDialogue(SEND_4_TEXT_CHAT,
					new String[] { NPCDefinitions.getNPCDefinitions(npcId).name, "Rules of Extinction-V2!",
			...
			sendEntityDialogue(SEND_4_TEXT_CHAT,
					new String[] { NPCDefinitions.getNPCDefinitions(npcId).name, "",
								"We hope you enjoy your stay on Extinction-Pk.V2!",
								".",
								""}, IS_NPC, npcId, 12379);
			stage = 6;
