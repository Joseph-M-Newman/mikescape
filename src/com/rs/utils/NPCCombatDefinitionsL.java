...
public static void loadCustomNPCDefinitions() {
		npcCombatDefinitions.put(14591, new NPCCombatDefinitions
			(700,64,65,67,4,2,-1,190,NPCCombatDefinitions.MELEE,-1,-1,NPCCombatDefinitions.AGRESSIVE));
	}
