...
public class SerializableFilesManager {
	...
	private static final String BACKUP_PATH = "data/charactersBackup/logoutDefaults/";
	private static final String BACKUP_UPDATE_PATH = "data/charactersBackup/UpdateBackup/";
	private static final String BACKUP_BAN_PATH = "data/charactersBackup/banningBackup/";
	...
	public static boolean updatingBackup(String username) {
		try {
			Utils.copyFile(new File(PATH + username + ".p"), new File(
					BACKUP_UPDATE_PATH + username + ".p"));
			return true;
		} catch (Throwable e) {
			Logger.handle(e);
			return false;
	...
	public static boolean banningBackup(String username) {
		try {
			Utils.copyFile(new File(PATH + username + ".p"), new File(
					BACKUP_BAN_PATH + username + ".p"));
			return true;
		} catch (Throwable e) {
			Logger.handle(e);
			return false;
